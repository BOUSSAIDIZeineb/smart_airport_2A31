...
int statistique::Statistique_partie2()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from voyageur where mois = 'avril'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie3()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from voyageur where mois = 'mai'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie4()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from voyageur where mois = 'juin'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie5()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from voyageur where mois = 'juillet'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie6()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from voyageur where mois = 'aout'") ;
    while(requete.next())
    {
            count++ ;
    }
