...
ries->append("res_fourniss",c3);
    ...
    q1.prepare("SELECT * FROM emp");
    q1.exec();

    q2.prepare("SELECT * FROM emp WHERE COMBO='choix1'");
    q2.exec();

    q3.prepare("SELECT * FROM emp WHERE COMBO='choix2'");
    q3.exec();

    q4.prepare("SELECT * FROM emp WHERE COMBO='choix3' ");
    q4.exec();
    ...
    //pie chart
        ...
        q4.prepare("SELECT * FROM emp WHERE COMBO='res_fourniss' ");
        q4.exec();
